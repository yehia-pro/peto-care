...
import PetGuide from './server/src/models/PetGuide';
import Disease from './server/src/models/Disease';
import { NO_PETS_CARDS_AR } from './src/data/noPets.ar';
import { COMMON_DISEASES_AR, RARE_DISEASES_AR } from './src/data/veterinaryDiseases.ar';
